...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_add_enterprise.setGeometry(QtCore.QRect(50, 30, 91, 61))
        ...
        self.button_add_data.setGeometry(QtCore.QRect(200, 30, 91, 61))
        self.button_add_data.setObjectName("button_add_data")
        self.button_start_analysis = QtWidgets.QPushButton(self.centralwidget)
        self.button_start_analysis.setGeometry(QtCore.QRect(350, 30, 91, 61))
        ...
        self.button_export_excel.setGeometry(QtCore.QRect(500, 30, 91, 61))
        ...
        self.button_click_refresh.setGeometry(QtCore.QRect(650, 30, 91, 61))
