...
from gui.add_enterprise_batch_dialog import Ui_AddEnterpriseBatchDialog
...
class AddEnterpriseBatchDialogLogic(QWidget, Ui_AddEnterpriseBatchDialog):
    ...
    def init_font(self):
        self.text_edit_add_enterprise_batch.setFont(font_16_family)
        self.button_add_enterprise_batch.setFont(font_15_family)

    def btn_connect(self):
        self.button_add_enterprise_batch.clicked.connect(self.save_enterprise_batch)

    def save_enterprise_batch(self):
        list_enterprise = self.text_edit_add_enterprise_batch.toPlainText().split("\n")
